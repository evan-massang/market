...
KNOWN = {
    ...
    "MIROFISH_MODE": (False, True, "required|degraded|off"),
    "MIROFISH_FORCE_FRESH": (False, True, "force a fresh project per market"),
    "MIROFISH_ALLOW_CACHE": (False, True, "allow cached reports"),
    "MIROFISH_MAX_REPORT_AGE_SECONDS": (False, True, "max report age"),
    "MIROFISH_MIN_POSTS": (False, True, "min crowd posts"),
    "MIROFISH_MIN_REPORT_CHARS": (False, True, "min report length"),
    "MIROFISH_REQUIRE_QUESTION_MATCH": (False, True, "require question match"),
